			...
			// консоль
				...
				if (consol==2) {header2.style.cssText="top:60px;" 
					add.style.cssText="left:30px; top:150px; width: 60px; height:60px; margin: 0px; border-radius: 30px;"
					main.style.cssText="top:150px;" // консоль опускаетс¤
				}	
				else {header2.style.cssText="top:-10px;"
					add.style.cssText="left:30px; top:80px; width: 60px; height:60px; margin: 0px; border-radius: 30px;"
